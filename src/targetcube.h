...
struct TargetCube : public Person {
    ...
    virtual vec3 update_xaxis_position(float dt) override {
        ...
        bool left = (bool) KeyMap::is_event(KeyMap::State::Game, "Target Left");
        bool right =
            (bool) KeyMap::is_event(KeyMap::State::Game, "Target Right");
    ...
    virtual vec3 update_zaxis_position(float dt) override {
        ...
        bool up =
            (bool) KeyMap::is_event(KeyMap::State::Game, "Target Forward");
        bool down = (bool) KeyMap::is_event(KeyMap::State::Game, "Target Back");
