...
inline AllLayerMappings create_default_layered_mapping() {
    ...
    mappings[menu::State::Game] = {
        ...
        {GameAction::PlayerForward, {KEY_W, GAMEPAD_BUTTON_LEFT_FACE_UP, GamepadAxisWithDir{GAMEPAD_AXIS_LEFT_Y, -1}}},
        {GameAction::PlayerBack, {KEY_S, GAMEPAD_BUTTON_LEFT_FACE_DOWN, GamepadAxisWithDir{GAMEPAD_AXIS_LEFT_Y, 1}}},
        {GameAction::PlayerLeft, {KEY_A, GAMEPAD_BUTTON_LEFT_FACE_LEFT, GamepadAxisWithDir{GAMEPAD_AXIS_LEFT_X, -1}}},
        {GameAction::PlayerRight, {KEY_D, GAMEPAD_BUTTON_LEFT_FACE_RIGHT, GamepadAxisWithDir{GAMEPAD_AXIS_LEFT_X, 1}}},

        // Player Actions
        {GameAction::PlayerPickup, {KEY_SPACE, GAMEPAD_BUTTON_RIGHT_FACE_DOWN}},
        {GameAction::PlayerRotateFurniture, {KEY_F, GAMEPAD_BUTTON_RIGHT_FACE_RIGHT}},
        {GameAction::PlayerDoWork, {KEY_R, GAMEPAD_BUTTON_RIGHT_FACE_LEFT}},
        {GameAction::PlayerHandTruckInteract, {KEY_C, GAMEPAD_BUTTON_RIGHT_FACE_UP}},
    ...
    LayerMapping ui_mapping = {
        ...
        {GameAction::ValueLeft, {KEY_LEFT, GAMEPAD_BUTTON_LEFT_FACE_LEFT, GamepadAxisWithDir{GAMEPAD_AXIS_LEFT_X, -1}}},
        {GameAction::ValueRight, {KEY_RIGHT, GAMEPAD_BUTTON_LEFT_FACE_RIGHT, GamepadAxisWithDir{GAMEPAD_AXIS_LEFT_X, 1}}},
...
inline menu::State get_initial_input_layer() {
