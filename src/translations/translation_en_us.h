...
constexpr CEMap<i18n, const char*, magic_enum::enum_count<i18n>()>
    pre_translation = {{{
        ...
        {i18n::ENABLE_LIGHTING, "Enable Lighting"},
        ...
        {i18n::VSYNC_ENABLED, "Enable VSync"},
