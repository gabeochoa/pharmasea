...
bitcount_t flog2(const uint_x4<UInt32, uint64_t>& v) {
    return v.d.v23 > 0
               ? flog2(v.d.v23) + uint_x4<UInt32, uint64_t>::UINT_BITS * 2
               : flog2(v.d.v01);
}

template<typename UInt32>
bitcount_t trailingzeros(const uint_x4<UInt32, uint64_t>& v) {
    return v.d.v01 == 0 ? trailingzeros(v.d.v23) +
                              uint_x4<UInt32, uint64_t>::UINT_BITS * 2
...
uint_x4<UInt32, uint64_t> operator<<(const uint_x4<UInt32, uint64_t>& v,
    ...
    if (shift >= bits2) {
        ...
        return {
            shift ? (v.d.v23 << shift) | (v.d.v01 >> (bits2 - shift)) : v.d.v23,
            v.d.v01 << shift};
    }
}
