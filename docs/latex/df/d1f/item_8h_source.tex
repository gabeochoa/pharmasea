...
\DoxyCodeLine{00007\ \textcolor{preprocessor}{\#include\ "{}engine/random.h"{}}}
...
\DoxyCodeLine{00019\ \ \ \ \ vec3\ \mbox{\hyperlink{struct_item_ab8f08a383347341fe2eba43cdbfa7dd3}{raw\_position}};}
\DoxyCodeLine{00020\ \ \ \ \ vec3\ \mbox{\hyperlink{struct_item_aa59326bb87cffcdcf4e7ca6715566b6f}{position}};}
...
\DoxyCodeLine{00054\ }
\DoxyCodeLine{00055\ \ \ \ \ vec3\ \mbox{\hyperlink{struct_item_a3a2607e15ddf8c337bc7480cadccf307}{snap\_position}}()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{namespacevec_a5a3a9e37c6f80541240d5cb6cdb4fd4e}{vec::snap}}(this-\/>raw\_position);\ \}}
\DoxyCodeLine{00056\ }
...
\DoxyCodeLine{00058\ }
\DoxyCodeLine{00059\ \ \ \ \ \textcolor{keyword}{virtual}\ vec3\ \mbox{\hyperlink{struct_item_a44db496c8de100b4f6e9bb7e546b0b4f}{model\_scale}}()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ \{0.5f,\ 0.5f,\ 0.5f\};\ \}}
\DoxyCodeLine{00060\ }
...
\DoxyCodeLine{00071\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ vec3\ scale\ =\ \{}
...
\DoxyCodeLine{00078\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ui::color::white);}
...
\DoxyCodeLine{00087\ \ \ \ \ \}}
\DoxyCodeLine{00088\ }
\DoxyCodeLine{00089\ \ \ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{struct_item_a04839eb08885c4f89378e636cc9df27f}{update\_position}}(\textcolor{keyword}{const}\ vec3\&\ p)\ \{}
...
\DoxyCodeLine{00098\ \ \ \ \ \}}
\DoxyCodeLine{00099\ }
\DoxyCodeLine{00100\ \ \ \ \ \textcolor{keyword}{virtual}\ vec3\ \mbox{\hyperlink{struct_item_a325a03f663374790e5ffc0b51f08683b}{size}}()\textcolor{keyword}{\ const\ }\{}
\DoxyCodeLine{00101\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ (vec3)\{\mbox{\hyperlink{struct_item_a5b372513381b796a0c9d947998695978}{item\_size}},\ \mbox{\hyperlink{struct_item_a5b372513381b796a0c9d947998695978}{item\_size}},\ \mbox{\hyperlink{struct_item_a5b372513381b796a0c9d947998695978}{item\_size}}\};}
\DoxyCodeLine{00102\ \ \ \ \ \}}
\DoxyCodeLine{00103\ }
...
\DoxyCodeLine{00126\ \ \ \ \ \ \ \ \ \ \ \ \ log\_info(\textcolor{stringliteral}{"{}cant\ eat\ because\ we\ cant\ hold\ things"{}});}
...
\DoxyCodeLine{00133\ \ \ \ \ \ \ \ \ \ \ \ \ log\_info(\textcolor{stringliteral}{"{}cant\ put\ an\ item\ into\ an\ item\ of\ the\ same\ type"{}});}
...
\DoxyCodeLine{00137\ \ \ \ \ \ \ \ \ \ \ \ \ log\_info(\textcolor{stringliteral}{"{}cant\ put\ an\ item\ into\ because\ we\ are\ full"{}});}
...
\DoxyCodeLine{00178\ \ \ \ \ \mbox{\hyperlink{struct_pill_a04e66b101b42aafa13f6f91036e3e1d4}{Pill}}(vec3\ p,\ Color\ c)\ :\ \mbox{\hyperlink{struct_item}{Item}}(p,\ c)\ \{\ \mbox{\hyperlink{struct_pill_aa6e10e02d49a8df3598a940a12b648d8}{init}}();\ \}}
\DoxyCodeLine{00179\ \ \ \ \ \mbox{\hyperlink{struct_pill_ad5f4f40b05fb82729a266cbe60fc3fc3}{Pill}}(vec2\ p,\ Color\ c)\ :\ \mbox{\hyperlink{struct_item}{Item}}(p,\ c)\ \{\ \mbox{\hyperlink{struct_pill_aa6e10e02d49a8df3598a940a12b648d8}{init}}();\ \}}
\DoxyCodeLine{00180\ }
...
\DoxyCodeLine{00183\ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{int}\ index\ =\ randIn(0,\ num\_pills\ -\/\ 1);}
...
\DoxyCodeLine{00185\ \ \ \ \ \}}
\DoxyCodeLine{00186\ }
\DoxyCodeLine{00187\ \ \ \ \ \textcolor{keyword}{virtual}\ vec3\ \mbox{\hyperlink{struct_pill_ab48d7f73a0c8367132397426da37d537}{model\_scale}}()\textcolor{keyword}{\ const\ override\ }\{\ \textcolor{keywordflow}{return}\ \{3.f,\ 3.0f,\ 12.f\};\ \}}
\DoxyCodeLine{00188\ }
...
\DoxyCodeLine{00192\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ ModelLibrary::get().get(\textcolor{stringliteral}{"{}pill\_red"{}});}
...
\DoxyCodeLine{00194\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ ModelLibrary::get().get(\textcolor{stringliteral}{"{}pill\_redlong"{}});}
...
\DoxyCodeLine{00196\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ ModelLibrary::get().get(\textcolor{stringliteral}{"{}pill\_blue"{}});}
...
\DoxyCodeLine{00198\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ ModelLibrary::get().get(\textcolor{stringliteral}{"{}pill\_bluelong"{}});}
\DoxyCodeLine{00199\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00200\ \ \ \ \ \ \ \ \ log\_warn(\textcolor{stringliteral}{"{}Failed\ to\ get\ matching\ model\ for\ pill\ type:\ \{\}"{}},}
...
\DoxyCodeLine{00216\ \ \ \ \ \mbox{\hyperlink{struct_pill_bottle_a9fe772b326eccf1ce640a998b98d533f}{PillBottle}}(vec3\ p,\ Color\ c)\ :\ \mbox{\hyperlink{struct_item}{Item}}(p,\ c)\ \{\}}
\DoxyCodeLine{00217\ \ \ \ \ \mbox{\hyperlink{struct_pill_bottle_a8a7055a72296bd56d6a80b4a93f17698}{PillBottle}}(vec2\ p,\ Color\ c)\ :\ \mbox{\hyperlink{struct_item}{Item}}(p,\ c)\ \{\}}
\DoxyCodeLine{00218\ }
\DoxyCodeLine{00219\ \ \ \ \ \textcolor{keyword}{virtual}\ vec3\ \mbox{\hyperlink{struct_pill_bottle_a38b4376e4d4994c9ac5728d1cb5fdd1f}{model\_scale}}()\textcolor{keyword}{\ const\ override\ }\{\ \textcolor{keywordflow}{return}\ \{3.f,\ 3.0f,\ 3.f\};\ \}}
\DoxyCodeLine{00220\ }
...
\DoxyCodeLine{00223\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ ModelLibrary::get().get(\textcolor{stringliteral}{"{}pill\_bottle"{}});}
\DoxyCodeLine{00224\ \ \ \ \ \}}
\DoxyCodeLine{00225\ \};}
\DoxyCodeLine{00226\ }
...
\DoxyCodeLine{00237\ \ \ \ \ \mbox{\hyperlink{struct_bag_a5c00a1e15483889c31a6a6231dce53ae}{Bag}}(vec3\ p,\ Color\ c)\ :\ \mbox{\hyperlink{struct_item}{Item}}(p,\ c)\ \{\}}
\DoxyCodeLine{00238\ \ \ \ \ \mbox{\hyperlink{struct_bag_a02b61c1c53e9adec80865ff59be0af50}{Bag}}(vec2\ p,\ Color\ c)\ :\ \mbox{\hyperlink{struct_item}{Item}}(p,\ c)\ \{\}}
\DoxyCodeLine{00239\ }
...
\DoxyCodeLine{00244\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ ModelLibrary::get().get(\textcolor{stringliteral}{"{}empty\_bag"{}});}
\DoxyCodeLine{00245\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00246\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ ModelLibrary::get().get(\textcolor{stringliteral}{"{}bag"{}});}
\DoxyCodeLine{00247\ \ \ \ \ \}}
\DoxyCodeLine{00248\ \};}
