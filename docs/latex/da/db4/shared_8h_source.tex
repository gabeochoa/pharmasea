...
\DoxyCodeLine{00023\ \ \ \ \ \ \ \ \ \ \ IsSolid,\ CanBeHeld,\ IsRotatable>\ \{\};}
\DoxyCodeLine{00024\ }
\DoxyCodeLine{00025\ \textcolor{keyword}{template}<>}
\DoxyCodeLine{00026\ \textcolor{keyword}{struct\ }PolymorphicBaseClass<\mbox{\hyperlink{struct_entity}{Entity}}>}
\DoxyCodeLine{00027\ \ \ \ \ :\ PolymorphicDerivedClasses<Furniture,\ Person>\ \{\};}
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \textcolor{keyword}{template}<>}
\DoxyCodeLine{00030\ \textcolor{keyword}{struct\ }PolymorphicBaseClass<\mbox{\hyperlink{struct_furniture}{Furniture}}>}
\DoxyCodeLine{00031\ \ \ \ \ :\ PolymorphicDerivedClasses<Wall,\ Table,\ Register,\ Conveyer,\ Grabber,}
\DoxyCodeLine{00032\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ BagBox,\ MedicineCabinet,\ CharacterSwitcher>\ \{\};}
\DoxyCodeLine{00033\ }
