...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*generate-project-context" exec="{project-root}/_bmad/bmgd/workflows/3-technical/generate-project-context/workflow.md">Create optimized project-context.md for AI agent consistency</item>
